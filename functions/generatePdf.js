...
//     shall serve as the primary coverage for the liability and personal injury protection limits required under Sections 324.021(7) 
//     and 627.736 of the Florida Statutes.Failure to return rented property or equipment upon the expiration of the rental period,
//             as well as failure to pay all amounts due(including costs for damages), constitutes prima facie evidence of intent to defraud 
//     and is punishable in accordance with Section 812.155 of the Florida Statutes
    
//     The Renter(s) attest that he / she is of at least 21 years of age and that he / she possesses a valid driver’s license and insurance as required by law. 
//     The operator(s) / renter(s) represents and warrants that he / she is insured under a policy of insurance which 
//     would provide coverage or injuries to the operator / renter and medical bills incurred as well as for damage
//      to the person and property of others should an accident occur during the operation or use of the rented
//         vehicle.The operator(s) / renter(s) attest that no other person shall drive the rental vehicle mentioned 
//      herein during the terms of this rental agreement or while rental vehicle is in possession of renter except
//         for the authorized drivers.Notice: Rental and leasing drivers insurance to be primary.The valid and 
//      collective liability insurance and personal injury protection insurance of any authorized rental or 
//      leasing driver is primary to the limits of liability and personal injury coverage required by 
//      SS.324.021(7) and 627.736, Florida Statutes. - You are hereby notified that by signing this contract below,
//             you agree that your own liability, personal injury protection and comp / collision will provide primary 
//       insurance coverage up to its full policy limits. - The renter agrees to return the rental property, or 
//       have ready for return, at the initial delivery address immediately upon completion of the rental period
//             in condition equal to that in which it was received with normal wear and tear accepted.The renter agrees
//        that if he or she has not returned said vehicle within 1 hour of the agreed upon time and at the above 
//        mentioned and agreed upon address, or is the vehicle is abandoned, he or she will bear all expenses
//         incurred by South Walton Carts LLC in attempting to locate and recover said vehicle, and hereby waves 
//         all recourse against South Walton Carts LLC or other authority responsible for renter’s arrest or
//         prosecution, even though the renter may consider such arrest or prosecution to be false, malicious 
//         or unjust. - In the event that the rental property becomes unsafe or in a state of disrepair, the 
//         Renter agrees to immediately discontinue use of property, and promptly notify South Walton Carts
//         LLC.The renter understands that in the event the property shall become inoperable through no fault 
//         of the renter, South Walton Carts LLC will take reasonable steps to have the vehicle repaired or
//         replaced.In the event a replacement is not available, the Rentor at his discretion may modify the 
//         rental agreement to reflect an adjustment of price on aprorated basis. - The renter(s) / operator(s) 
//         understand that a Low Speed Vehicle is a motorized vehicle that is only permitted on roads of 35 mph or
//          less and ALL TRAFFIC LAWS MUST BE OBEYED.The renter(s) / operator(s) represent and warrant that he / she 
//          is familiar with the traffic rules, laws and regulations of the municipality wherein the rented vehicle
//           is to be operated and will at all times comply strictly with the same.No driver under the age of 21 
//           years old is allowed to drive.
//           Other Terms :
...
//         // Define page margins and text settings
//         const fontSize = 10 ;
//         const lineHeight = 12; // Slightly increased for better readability
//         const marginLeft = 50;
//         const marginRight = 50;
//         const textWidth = 600 - marginLeft - marginRight; // Calculate the width available for text
//         let currentY = 720; // Start below the header

//         // Load a font for measuring text width
//         const font = await pdfDoc.embedStandardFont('Helvetica');
//         const wrappedLines = [];

//         // Split the text into words and wrap lines
//         text.split('\n').forEach((paragraph) => {
...
//                 wrappedLines.push(line.trim());
//             }
//             wrappedLines.push(''); // Add a blank line between paragraphs
//         });

//         // Draw each wrapped line on the PDF
//         wrappedLines.forEach((line) => {
//             if (currentY < 50) {
//                 // Add a new page when the current page runs out of space
...
//         const fileName = `ImportantInformation.pdf`;
//         const filePath = path.join(__dirname, fileName);
//         fs.writeFileSync(filePath, pdfBytes);

//         // Construct the public URL for accessing the PDF
//         const pdfUrl = `${process.env.FRONTEND}pdfs/${fileName}`;
//         console.log(pdfUrl);
